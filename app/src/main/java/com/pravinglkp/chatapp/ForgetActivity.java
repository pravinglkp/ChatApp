        ...
        auth.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NotNull Task<Void> task) {
                if(task.isSuccessful()){
                    Toast.makeText(ForgetActivity.this,"Reset Link Sent Successfull",Toast.LENGTH_LONG).show();
                }
                else{
                    Toast.makeText(ForgetActivity.this,"Reset Link Sent Unsuccessfull",Toast.LENGTH_LONG).show();
                }
            }
        });
    }
